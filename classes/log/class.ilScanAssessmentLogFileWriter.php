...
ilScanAssessmentPlugin::getInstance()->includeClass('log/class.ilScanAssessmentLogTraceProcessor.php');
ilScanAssessmentPlugin::getInstance()->includeClass('log/class.ilScanAssessmentLoggingSettings.php');
/**
